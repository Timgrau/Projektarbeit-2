...
%% Erzeugt ein passendes Titelblatt fÃ¼r die Projektarbeit
...
\newcommand{\myprojectworktitle}[1]{
  ...
  \end{figure}
%% anstelle der folgenden Zeile, um das FH-Logo mit einzufï¿½gen:
  \vskip 5.5cm
  \begin{center}%
...
%% Diese Zeile unbedingt stehen lassen und anpassen - sie enthÃ¯Â¿Â½lt Autor und Titel der Ausarbeitung
\mywork{Timo Grautstück}{Werkzeuge für die Algorithmenimplementierung auf Quantencomputern}
